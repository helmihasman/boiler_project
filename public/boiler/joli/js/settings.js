var site_settings = '<div class="ts-button">'
    ...
    +'</div>'
    +'<div class="ts-body">'
	    +'<div class="ts-title">Language Selection</div>'
        +'<div class="ts-themes"><ul>'
            +'<li><a href="#" style="color:white">English</a></li>'            
            +'<li><a href="#" style="color:white">Thailand</a></li>'
            +'<li><a href="#" style="color:white">Myanmar</a></li>'                        
            +'<li><a href="#" style="color:white">Cambodia</a></li></ul>'
